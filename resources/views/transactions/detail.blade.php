        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="w-full rounded overflow-hidden shadow-lg px-6 py-6 bg-white">
                <div class="flex flex-wrap -mx-4 -mb-4 md:mb-0">
                    <div class="w-full md:w-1/6 px-4 mb-4 mb:mb-0">
                        <img src="{{ $item->food->picturePath}}" alt="" class="w-full rounded">
                    </div>
                    <div class="w-full md:w-5/6 px4 mb-4 md:mb-0">
                        <div class="flext flex-wrap mb-3">
                            <div class="w-2/6">
                                <div class="text-sm">Product Name</div>
                                <div class="text-xm font-bold">{{ $item->food->name }}</div>
                            </div>
                            <div class="w-1/6">
                                <div class="text-sm">Quantity</div>
                                <div class="text-xm font-bold">{{ number_format($item->quantity) }}</div>
                            </div>
                            <div class="w-1/6">
                                <div class="text-sm">Total</div>
                                <div class="text-xm font-bold">{{ number_format($item->total) }}</div>
                            </div>
                            <div class="w-1/6">
                                <div class="text-sm">Quantity</div>
                                <div class="text-xm font-bold">{{ $item->status }}</div>
                            </div>
                        </div>
                        <div class="flext flex-wrap mb-3">
                            <div class="w-2/6">
                                <div class="text-sm">User Name</div>
                                <div class="text-xm font-bold">{{ $item->user->name }}</div>
                            </div>
                            <div class="w-3/6">
                                <div class="text-sm">Email</div>
                                <div class="text-xm font-bold">{{ $item->user->email }}</div>
                            </div>
                            <div class="w-1/6">
                                <div class="text-sm">City</div>
                                <div class="text-xm font-bold">{{ $item->user->city }}</div>
                            </div>
                        </div>
                        <div class="flext flex-wrap mb-3">
                            <div class="w-4/6">
                                <div class="text-sm">Address</div>
                                <div class="text-xm font-bold">{{ $item->user->address }}</div>
                            </div>
                            <div class="w-1/6">
                                <div class="text-sm">HouseNumber</div>
                                <div class="text-xm font-bold">{{ $item->user->houseNumber }}</div>
                            </div>
                            <div class="w-1/6">
                                <div class="text-sm">PhoneNumber</div>
                                <div class="text-xm font-bold">{{ $item->user->phoneNumber  }}</div>
                            </div>
                            <div class="flext flex-wrap mb-3">
                                <div class="w-5/6">
                                ...
                                <div class="w-1/6">
                                    ...
                                    <a href="{{ route('transactions.changeStatus', ['id' => $item->id, 'status' => 'CANCELLED']) }}"
                                        class="bg-red-500 hover:bg-red-700 text-black font-bold px-2 rounded block text-center w-full mb-1">
                                        Cancelled
                                    </a>
                                </div>
                            </div>
